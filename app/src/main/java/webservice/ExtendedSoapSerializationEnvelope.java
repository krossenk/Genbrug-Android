...
public class ExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    ...
    static {
        classNames.put("http://recycle/^^user", User.class);
        classNames.put("http://recycle/^^address", Address.class);
        classNames.put("http://recycle/^^subscription", Subscription.class);
        classNames.put("http://recycle/^^publication", Publication.class);
        classNames.put("http://recycle/^^category", Category.class);
        classNames.put("http://recycle/^^getPublicationSubscriptionsResponse", getPublicationSubscriptionsResponse.class);
        classNames.put("http://recycle/^^getUserSubscriptionsResponse", getUserSubscriptionsResponse.class);
        classNames.put("http://recycle/^^getAllPublicationsResponse", getAllPublicationsResponse.class);
    }   
