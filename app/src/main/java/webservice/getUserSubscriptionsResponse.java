...
public class getUserSubscriptionsResponse extends Vector<Subscription> implements KvmSerializable
{
    
    public getUserSubscriptionsResponse(){}
    
    public getUserSubscriptionsResponse(java.lang.Object inObj, ExtendedSoapSerializationEnvelope __envelope)
    {
        if (inObj == null)
            return;
